    ...
    #Time to configure the hand specifically into the ROI...
        ...
        if hand is not None:
            ...
            if num_imgs_taken <= 40:
                #cv2.imwrite(r"C:\Users\sreej\Downloads\sign-language-recognition-project (3)\gestures\train"+str(element)+"\\" + str(num_imgs_taken+300) + '.jpg', thresholded)
                cv2.imwrite(r"C:\Users\sreej\Downloads\model"+"\\" + str(num_imgs_taken) + '.jpg', thresholded)
            else:
                break
            num_imgs_taken +=1
        else:
